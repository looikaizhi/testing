...
pub const DEFAULT_REVEAL_RECV_PERCENT: usize = 100;
...
pub struct BenchGroupItem {
    ...
    #[serde(rename = "reveal-recv-percent")]
    pub reveal_recv_percent: Option<usize>,
}
...
impl BenchItem {
    pub fn apply_group(&mut self, group: &BenchGroupItem) {
        ...
        if self.reveal_recv_percent.is_none() {
            self.reveal_recv_percent = group.reveal_recv_percent;
        }
    }
    ...
    pub fn into_bench(&self) -> Bench {
        Bench {
            ...
            reveal_recv_percent: self
                .reveal_recv_percent
                .unwrap_or(DEFAULT_REVEAL_RECV_PERCENT),
        }
    }
}
...
pub struct ProverMetrics {
    ...
    /// Actual revealed percentage of received transcript bytes.
    pub reveal_recv_percent_actual: Option<f64>,
...
impl Measurement {
    pub fn new(config: Bench, metrics: ProverMetrics) -> Self {
        Self {
            ...
            reveal_recv_percent_actual: metrics.reveal_recv_percent_actual,
